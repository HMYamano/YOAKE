...
from htrtdetr.config import get_stage3_config, HTRTDETRConfig, clamp_temporal_branches
...
def main() -> None:
    ...
    logger = get_logger("stage3", log_file=str(Path(cfg.train.output_dir) / "stage3.log"))
    logger.info("Stage 3: ID Head Training")
    ...
    if use_dummy:
        ...
        train_dataset = SlidingWindowDataset(
            ...
            augment=cfg.data.augment_train, require_track=True,
